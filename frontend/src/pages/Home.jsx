        ...
        <div className="hidden lg:flex flex-col">
          ...
          <div className="flex items-center gap-4 px-4 py-3 max-w-screen-xl mx-auto w-full">
            ...
            <Link to="/" className="shrink-0 flex items-center">
              <img src="https://i.postimg.cc/nV3SQ1K8/download-(8).jpg" alt="Logo" className="h-9 w-auto object-contain" />
            </Link>
        ...
        <div className="flex lg:hidden items-center justify-between px-3 py-3">
          <div className="flex items-center gap-2">
            ...
            <Link to="/" className="flex items-center gap-2">
              <img src="https://i.postimg.cc/nV3SQ1K8/download-(8).jpg" alt="Logo" className="h-8 w-auto object-contain" />
