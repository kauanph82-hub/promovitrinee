        ...
        <div className="hidden lg:flex flex-col">
          ...
          <div className="flex items-center gap-4 px-4 py-3 max-w-screen-xl mx-auto w-full">
            ...
            <Link to="/" className="shrink-0 flex items-center">
              <img src="https://i.postimg.cc/vBkz300m/Fire-Emoji-(1).png" alt="Logo" className="h-9 w-auto object-contain" />
            </Link>
        ...
        <div className="flex lg:hidden items-center justify-between px-3 py-3">
          <div className="flex items-center gap-2">
            ...
            <Link to="/" className="flex items-center gap-2">
              <img src="https://i.postimg.cc/vBkz300m/Fire-Emoji-(1).png" alt="Logo" className="h-8 w-auto object-contain" />
              <span className="text-xs font-bold text-[#00AAB5] leading-tight">melhores<br/>promoções!</span>
            </Link>
          </div>
          <div className="flex items-center gap-2">
