  ...
  return (
    <div style={{ fontFamily: "'Rubik', sans-serif" }} className="min-h-screen bg-[#f4f4f4] pb-20 lg:pb-0">
      ...
      <header className="sticky top-0 z-40 bg-white border-b border-gray-200 shadow-sm">
        ...
        <div className="hidden lg:flex flex-col">
          ...
          <div className="flex items-center gap-4 px-4 py-3 max-w-screen-xl mx-auto w-full">
            ...
            <Link to="/" className="shrink-0 flex items-center">
              <img src="https://i.postimg.cc/1RX5SSp2/gemini-2-5-flash-image-quero-que-vc-troque-o-nome-o-simbulo-por-esse-de-cupom-e-quero-que-vc-troque.png" alt="Logo" className="object-contain" style={{ height: '64px', width: 'auto', minWidth: '160px' }} />
            </Link>
            ...
            <div className="flex items-center gap-1 ml-auto">
              ...
              {/* Avatar — sem link */}
              <div className="flex flex-col items-center gap-1 w-[90px] py-1">
                <img src={ADMIN_AVATAR} alt="Perfil" className="w-10 h-10 rounded-full object-cover border-2 border-gray-200" />
                <span className="text-[10px] text-gray-500 text-center leading-tight truncate w-full px-1">kauan phellipe</span>
              </div>
            </div>
          </div>
        ...
        <div className="flex lg:hidden items-center justify-between px-3 py-3">
          <div className="flex items-center gap-2">
            ...
            <Link to="/"><img src="https://i.postimg.cc/1RX5SSp2/gemini-2-5-flash-image-quero-que-vc-troque-o-nome-o-simbulo-por-esse-de-cupom-e-quero-que-vc-troque.png" alt="Logo" className="object-contain" style={{ height: '44px', width: 'auto', minWidth: '110px' }} /></Link>
          </div>
          <div className="flex items-center gap-2">
            ...
            <img src={ADMIN_AVATAR} alt="Perfil" className="w-8 h-8 rounded-full object-cover border border-gray-200" />
          </div>
        </div>
      ...
      <footer className="border-t-4 border-[#00AAB5] bg-white py-8 text-center text-gray-400 text-sm mt-4">
        <img src="https://i.postimg.cc/1RX5SSp2/gemini-2-5-flash-image-quero-que-vc-troque-o-nome-o-simbulo-por-esse-de-cupom-e-quero-que-vc-troque.png" alt="Logo" className="h-8 w-auto object-contain mx-auto mb-2" />
      ...
      <nav className="fixed bottom-0 left-0 z-20 h-20 w-full flex items-start justify-between border-t border-gray-200 bg-white shadow-[0_-2px_4px_0_rgba(19,19,19,0.1)] lg:hidden px-1">
        ...
        <button className="flex h-full flex-1 flex-col items-center justify-start px-0 pt-4 text-center text-gray-400">
          ...
          <p className="text-xs font-bold mt-1">Notificações</p>
        </button>
      </nav>
    </div>
  );
